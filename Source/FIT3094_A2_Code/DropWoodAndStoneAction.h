 ...
 * 
 */
class FIT3094_A2_CODE_API DropWoodAndStoneAction : public GOAPAction
{
public:
	DropWoodAndStoneAction();
	~DropWoodAndStoneAction();
...
private:
	...
	// A pointer to the building. Stored so that we don't waste
	...
	// Check if builders have dropped all resources
	bool WoodAndStoneDropped;
