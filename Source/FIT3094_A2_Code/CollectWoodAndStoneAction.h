 ...
 * 
 */
class FIT3094_A2_CODE_API CollectWoodAndStoneAction : public GOAPAction
{
public:
	CollectWoodAndStoneAction();
	~CollectWoodAndStoneAction();
...
private:
	...
	// Check if builders have gather max resources
	bool WoodAndStoneResourceCollected;
